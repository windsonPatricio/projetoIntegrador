...
<body style="height: 654px;width: 1184px;">
    <div class="login-dark" style="height: 655px;color: rgb(34,41,33);background-image: url(&quot;assets/img/69c5447812732c7dfc108aef37e59fa8.jpg&quot;);width: 1279px;">
        <form method="post" style="background-color: rgba(6,5,5,0.21);">
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email" style="background-color: #171010;"></div>
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password" style="background-color: #171010;"></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(33,48,128);">Log In</button></div>
        </form>
    </div>
